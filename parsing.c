...
/*   Updated: 2025/07/10 10:52:04 by jasminelage      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// argv[1] = number_philosophers >> normal number
...
{
	table->number_philosophers = ft_atol(argv[1]);
	...
	if (table->number_philosophers <= 0 || table->time_to_die <= 0 || 
		table->time_to_eat <= 0 || table->time_to_sleep <= 0)
		return_error("Use only positive numbers");
	if (table->number_philosophers > INT_MAX || table->time_to_die > INT_MAX ||
